...
import { Box, Button, HStack, Heading, Input, Spinner, Stack, Text, useColorMode, VStack } from '@chakra-ui/react';
            ...
            >
                ...
                <Box maxW="650px" w={{ lg: '100%' }} m={"inherit"}>
                    <VStack spacing={6} className="mb-4 pr-0">
                        <Text fontSize="3xl" fontWeight="bold" color={colorMode === 'dark' ? 'brand.white' : 'brand.amber'} mt={6}>Recent Posts</Text>
                        <Input
